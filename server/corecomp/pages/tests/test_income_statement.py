...
def test_valid_fetch(mock_get_income_statement, mock_annotate_profit_margin, authorized_client):
    symbol = Symbol(
        symbol="IBM",
    ...
    mock_get_income_statement.return_value = return_value
...
@patch("pages.views.overview.financial_data_service.get_income_statement")
@pytest.mark.django_db
def test_valid_cache(mock_get_income_statement, mock_annotate_profit_margin, authorized_client):
    symbol = Symbol(
        symbol="IBM",
        name="International Business Machines Corp",
        type="Stock"
...
@patch("pages.views.overview.financial_data_service.get_income_statement")
@pytest.mark.django_db
def test_symbol_not_in_alpha_vantage(mock_get_income_statement, authorized_client):
    symbol = Symbol(
        symbol="IBM",
        name="International Business Machines Corp",
        type="Stock"
