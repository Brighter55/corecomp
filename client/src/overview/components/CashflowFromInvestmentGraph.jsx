...
function CashflowFromInvestmentGraph({ statement, period }) {
    ...
    const reports = useMemo(() => {
        ...
        console.log("CashflowFromInvestmentGraph: ", filteredReports);
    ...
    const percentChange = useMemo(() => {
        ...
        const percentChange = getPercentChange(reports, "cashflowFromInvestment");
                ...
                <Box onClick={() => {setGraphClicked(true);}} sx={{ width: "100%", height: "100%" }}>
                    <ResponsiveContainer>
                        ...
                        >
                            ...
                            <Bar name="Cashflow from Investment" dataKey="cashflowFromInvestment" shape={<CustomBar></CustomBar>}  activeBar={<CustomActiveBar></CustomActiveBar>} />
                        </BarChart>
                    </ResponsiveContainer>
                </Box>
            </GraphCard>
