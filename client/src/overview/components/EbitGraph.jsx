...
function EbitGraph({ symbol, fetchVersion, setSymbol, period }) {
    ...
    const reports = useMemo(() => {
        ...
        console.log("EBIT: ", filteredReports);
    ...
    const percentChange = useMemo(() => {
        ...
        const percentChange = getPercentChange(reports, "ebit");
                    ...
                    <Box onClick={() => {setGraphClicked(true);}} sx={{ width: "100%", height: "100%" }}>
                        <ResponsiveContainer>
                            ...
                            >
                                ...
                                <Bar name="EBIT" dataKey="ebit" shape={<CustomBar></CustomBar>}  activeBar={<CustomActiveBar></CustomActiveBar>} />
                            </BarChart>
                        </ResponsiveContainer>
                    </Box>
                </GraphCard>
