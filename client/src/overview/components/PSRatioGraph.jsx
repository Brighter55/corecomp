...
export default function PSRatioGraph({ statement, period }) {
    ...
    const reports = useMemo(() => {
        ...
        console.log("PSRatioGraph: ", filteredReports);
    ...
    const percentChange = useMemo(() => {
        ...
        const percentChange = getPercentChange(reports, "PSRatio");
                    ...
                    <Box onClick={() => {setGraphClicked(true);}} sx={{ width: "100%", height: "100%" }}>
                        <ResponsiveContainer>
                            ...
                            >
                                ...
                                <Tooltip
                                />
                                <Bar name="P/S Ratio" dataKey="PSRatio" shape={<CustomBar></CustomBar>} activeBar={<CustomActiveBar></CustomActiveBar>}/>
                            </BarChart>
                        </ResponsiveContainer>
                    </Box>
                </GraphCard>
