...
function GrossProfitGraph({ statement, period }) {
    ...
    const reports = useMemo(() => {
        ...
        console.log("GrossProfitGraph: ", filteredReports);
    ...
    const percentChange = useMemo(() => {
        ...
        return getPercentChange(reports, "grossProfit");
    }, [reports]);
                ...
                <Box onClick={() => { setGraphClicked(true); }} sx={{ width: "100%", height: "100%" }}>
                    <ResponsiveContainer>
                        ...
                        >
                            ...
                            <Bar name="Gross Profit" dataKey="grossProfit" shape={<CustomBar></CustomBar>} activeBar={<CustomActiveBar></CustomActiveBar>} />
                        </BarChart>
                    </ResponsiveContainer>
                </Box>
            </GraphCard>
